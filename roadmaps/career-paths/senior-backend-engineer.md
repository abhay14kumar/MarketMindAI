# Senior Backend Engineer Career Path
...
- Select role-specific topics from the [Skill Matrix](../../knowledge/indexes/SKILL_MATRIX.md).
- Follow the [Dependency Graph](../../knowledge/graphs/DEPENDENCY_GRAPH.md).
- Attach evidence through the [Progress Tracker](../../knowledge/indexes/PROGRESS_TRACKER.md).
