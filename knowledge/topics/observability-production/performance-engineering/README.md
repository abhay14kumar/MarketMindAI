---
id: meks-observability-production-performance-engineering
title: Performance Engineering
domain: Observability Production
status: planned
...
**Performance Engineering**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Health, diagnostics, and production readiness |
