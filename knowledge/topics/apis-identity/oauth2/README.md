---
id: meks-apis-identity-oauth2
title: OAuth 2.0
domain: Apis Identity
status: planned
...
**OAuth 2.0**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Public and internal API contracts |
