---
id: meks-engineering-foundation-hexagonal-architecture
...
**Hexagonal Architecture**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Architecture, coding standards, and ADRs |
