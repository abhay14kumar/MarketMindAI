---
id: meks-platform-cloud-kubernetes
title: Kubernetes
...
**Kubernetes**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Docker, Kubernetes, and Helm deployment |
