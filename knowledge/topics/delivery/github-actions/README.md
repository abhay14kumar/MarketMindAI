---
id: meks-delivery-github-actions
...
**Github Actions**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Repository workflow and delivery automation |
