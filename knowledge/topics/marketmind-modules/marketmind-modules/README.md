---
id: meks-marketmind-modules-marketmind-modules
title: Marketmind Modules
domain: Marketmind Modules
status: planned
...
**Marketmind Modules**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Production module implementation |
