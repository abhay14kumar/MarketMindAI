---
id: meks-product-development-product-development
...
**Product Development**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | MarketMind product discovery and delivery |
