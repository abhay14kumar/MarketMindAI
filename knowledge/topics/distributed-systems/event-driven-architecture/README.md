---
id: meks-distributed-systems-event-driven-architecture
...
**Event Driven Architecture**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Schedulers, pipelines, providers, and future events |
