---
id: meks-testing-security-security-engineering
...
**Security Engineering**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Verification, trust boundaries, and secure delivery |
