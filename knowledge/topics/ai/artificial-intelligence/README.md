---
id: meks-ai-artificial-intelligence
...
**Artificial Intelligence**. Keep detailed teaching material in `academy/` and link it
...
|---|---|
| Status | Planned |
| MarketMind area | Document extraction, embeddings, retrieval, and AI research |
